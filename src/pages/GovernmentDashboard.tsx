    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="p-4 flex items-center justify-between border-b border-border">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-foreground">BESCOM Admin</h1>
            <p className="text-xs text-muted-foreground">Utility Dashboard</p>
          </div>
        </div>
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="glass rounded-2xl p-4">
            ...
            <p className="text-xl font-bold text-foreground">{(impactMetrics.households / 1000).toFixed(0)}K</p>
          ...
          <div className="glass rounded-2xl p-4">
            ...
            <p className="text-xl font-bold text-foreground">{impactMetrics.co2Reduced} tons</p>
        ...
        <div className="glass rounded-2xl p-4">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-semibold text-foreground">Regional Usage Trends</h3>
            </div>
          ...
          <div className="space-y-3">
            {regions.map((region) => (
              <div key={region.name} className="flex items-center gap-3">
                <span className="text-xs text-foreground w-24 truncate">{region.name}</span>
                ...
                <div className={`flex items-center gap-0.5 text-xs font-medium w-12 justify-end ${
        ...
        <div className="glass rounded-2xl p-4">
          <div className="flex items-center gap-2 mb-4">
            <BarChart3 className="w-4 h-4 text-energy-foreground" />
            <h3 className="text-sm font-semibold text-foreground">Today's Peak Demand</h3>
          </div>
          <div className="h-32">
        ...
        <div className="glass rounded-2xl p-4">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-sm font-semibold text-foreground">Platform Impact</h3>
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div className="p-3 rounded-xl bg-energy/10">
              <Zap className="w-4 h-4 text-energy-foreground mb-1" />
            ...
            <div className="p-3 rounded-xl bg-water/10">
              <Droplets className="w-4 h-4 text-water-foreground mb-1" />
              <p className="text-lg font-bold text-foreground">
        ...
        <div className="fixed inset-0 z-50 bg-background/80 backdrop-blur-sm flex items-end sm:items-center justify-center p-4">
          <div className="glass rounded-2xl p-6 w-full max-w-sm animate-slide-up">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground">Send Public Alert</h3>
